...
if (empty($object_array)) {
    ...
    foreach ($object_array as $doc) {
        $htmlContent2 .= '<tr data-id"' . $doc["doc_id"] . '" style="height:35px;"><td class="align-middle" style="color:rgb(0,0,0);font-size:14px;padding:5px 10px;">' . $doc["doc_trackingnum"];
        $htmlContent2 .= '</td><td class="align-middle" style="color:rgb(0,0,0);font-size:14px;padding:5px 10px;">' . $doc["doc_name"];
        $htmlContent2 .= '</td><td class="align-middle" style="color:rgb(0,0,0);font-size:14px;padding:5px 10px;">' . $doc["queue"];
        if ($doc["queue"] != NULL)
            $htmlContent2 .= ' day/s';
        $htmlContent2 .= '</td><td class="align-middle" style="color:rgb(0,0,0);font-size:14px;padding:5px 10px;">';

        $htmlContent2 .= strlen($doc["doc_owner"]) < 31 ? $doc["doc_owner"] : substr($doc["doc_owner"], 0, 30) . "...";

        $htmlContent2 .= '</td><td class="align-middle" style="color:rgb(0,0,0);font-size:14px;padding:5px 10px;">' . $doc["doc_status"];
