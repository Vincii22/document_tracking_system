...
<img src="../assets/images/divineLogo.jpg" alt="Document Tracking System Logo" style="width: 100%; height: auto; margin-bottom: 20px;">
        ...
        <a href="user_mgmt.php" title="User Management" data-toggle="tooltip"><i class="fa fa-users"></i></a>
        <a href="dept_mgmt.php" title="Department Management" data-toggle="tooltip" class="active"><i class="fa fa-building"></i></a>
    </div>
    <div>
